This is the Jazz README file for Jazz Version 1.0
...
We are following an Open Source model to make sure that the
...
register in order to download Jazz, but we appreciate it if you do. 
We can make a stronger case for the success of Jazz if we know 
who is using it.  Register at:
http://www.cs.umd.edu/hcil/jazz/download/register
...
The Original Code is the Jazz Java Zooming Interface v1.0. 
...
Contributor(s): Ben Bederson; Britt McAlister; Jim Mokwa; Lance Good; Jon Meyer" 
